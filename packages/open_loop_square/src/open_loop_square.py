...
class Drive_Square:
    def __init__(self):
        ...
        #Initialize Pub/Subs
        self.pub = rospy.Publisher('/prtc/car_cmd_switch_node/cmd', Twist2DStamped, queue_size=1)
        rospy.Subscriber('/prtc/fsm_node/mode', FSMState, self.fsm_callback, queue_size=1)
